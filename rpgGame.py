...
while running:
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_e:
                ...
                if current_map == layer_begin_bot and layer_c_begin[((character.rect.top + character.rect.bottom) // 2) // TILE_SIZE][((character.rect.left + character.rect.right) // 2) // TILE_SIZE] in ['4']:
                    ...
                    character.rect = Rect(440, 630, CHARACTER_SIZE[0], CHARACTER_SIZE[1])
    ...
    if current_map == layer_house and layer_c_house[((character.rect.top + character.rect.bottom) // 2) // TILE_SIZE][((character.rect.left + character.rect.right) // 2) // TILE_SIZE] in ['s']:
        character.rect = Rect(25 * 32, 7 * 32, CHARACTER_SIZE[0], CHARACTER_SIZE[1])
        character.direction = 3

    if current_map == layer_house and layer_c_house[((character.rect.top + character.rect.bottom) // 2) // TILE_SIZE][((character.rect.left + character.rect.right) // 2) // TILE_SIZE] in ['S']:
        character.rect = Rect(30 * 32, 13 * 32, CHARACTER_SIZE[0], CHARACTER_SIZE[1])
